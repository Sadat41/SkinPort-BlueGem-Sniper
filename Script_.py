...
async def send_discord_notification(users, channel_id, item, rank):
    ...
    embed = {
        "title": f"🔥 Rank {rank} {market_hash_name} Detected!",
        "description": (
        ...
        "color": 0xFF5733,
        "fields": [
            {"name": "🧲 Skinport Link", "value": f"[Buy Now](https://skinport.com/item/{item['url']})", "inline": True},
            {"name": "🔍 Inspect Link", "value": f"[Inspect in Game]({item.get('link', 'N/A')})", "inline": True},
        ],
        "footer": {"text": "🚨🗿 Powered by SkinPort Sniper", "icon_url": "https://skinport.com/favicon.ico"},
    }
